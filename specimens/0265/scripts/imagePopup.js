$(document).ready(function() {
	...
	$('#img_alive5').click( function(e) {
		e.preventDefault();
		prepareShow();
		$("#div_img_alive5").show();
	});
	$('#div_img_alive5').click(function(){
		prepareHide();
		$("#div_img_alive5").hide();
	});
	$('#div_close_img_alive5').click(function(){
		prepareHide();
		$("#div_img_alive5").hide();
	});

	$('#img_alive6').click( function(e) {
		e.preventDefault();
		prepareShow();
		$("#div_img_alive6").show();
	});
	$('#div_img_alive6').click(function(){
		prepareHide();
		$("#div_img_alive6").hide();
	});
	$('#div_close_img_alive6').click(function(){
		prepareHide();
		$("#div_img_alive6").hide();
	});

	$('#img_alive7').click( function(e) {
		e.preventDefault();
		prepareShow();
		$("#div_img_alive7").show();
	});
	$('#div_img_alive7').click(function(){
		prepareHide();
		$("#div_img_alive7").hide();
	});
	$('#div_close_img_alive7').click(function(){
		prepareHide();
		$("#div_img_alive7").hide();
	});

	$('#img_alive8').click( function(e) {
		e.preventDefault();
		prepareShow();
		$("#div_img_alive8").show();
	});
	$('#div_img_alive8').click(function(){
		prepareHide();
		$("#div_img_alive8").hide();
	});
	$('#div_close_img_alive8').click(function(){
		prepareHide();
		$("#div_img_alive8").hide();
	});

	$('#img_alive9').click( function(e) {
		e.preventDefault();
		prepareShow();
		$("#div_img_alive9").show();
	});
	$('#div_img_alive9').click(function(){
		prepareHide();
		$("#div_img_alive9").hide();
	});
	$('#div_close_img_alive9').click(function(){
		prepareHide();
		$("#div_img_alive9").hide();
	});

	$('#img_alive10').click( function(e) {
		e.preventDefault();
		prepareShow();
		$("#div_img_alive10").show();
	});
	$('#div_img_alive10').click(function(){
		prepareHide();
		$("#div_img_alive10").hide();
	});
	$('#div_close_img_alive10').click(function(){
		prepareHide();
		$("#div_img_alive10").hide();
	});
