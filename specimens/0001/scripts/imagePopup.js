$(document).ready(function() {
	...
	$('#img_preliminary_attempt0').click( function(e) {
		e.preventDefault();
		prepareShow();
		$("#div_img_preliminary_attempt0").show();
	});
	$('#div_img_preliminary_attempt0').click(function(){
		prepareHide();
		$("#div_img_preliminary_attempt0").hide();
	});
	$('#div_close_img_preliminary_attempt0').click(function(){
		prepareHide();
		$("#div_img_preliminary_attempt0").hide();
	});
