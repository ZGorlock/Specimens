$(document).ready(function() {
	...
	$('#img_suspension4').click( function(e) {
		e.preventDefault();
		prepareShow();
		$("#div_img_suspension4").show();
	});
	$('#div_img_suspension4').click(function(){
		prepareHide();
	$("#div_img_suspension4").hide();
	});
	$('#div_close_img_suspension4').click(function(){
		prepareHide();
	$("#div_img_suspension4").hide();
	});

	$('#img_suspension5').click( function(e) {
		e.preventDefault();
		prepareShow();
		$("#div_img_suspension5").show();
	});
	$('#div_img_suspension5').click(function(){
		prepareHide();
	$("#div_img_suspension5").hide();
	});
	$('#div_close_img_suspension5').click(function(){
		prepareHide();
	$("#div_img_suspension5").hide();
	});

	$('#img_suspension6').click( function(e) {
		e.preventDefault();
		prepareShow();
		$("#div_img_suspension6").show();
	});
	$('#div_img_suspension6').click(function(){
		prepareHide();
	$("#div_img_suspension6").hide();
	});
	$('#div_close_img_suspension6').click(function(){
		prepareHide();
	$("#div_img_suspension6").hide();
	});

	$('#img_suspension7').click( function(e) {
		e.preventDefault();
		prepareShow();
		$("#div_img_suspension7").show();
	});
	$('#div_img_suspension7').click(function(){
		prepareHide();
	$("#div_img_suspension7").hide();
	});
	$('#div_close_img_suspension7').click(function(){
		prepareHide();
	$("#div_img_suspension7").hide();
	});
